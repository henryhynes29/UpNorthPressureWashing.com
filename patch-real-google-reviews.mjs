...
.review-slider{display:grid;grid-auto-flow:column;grid-auto-columns:minmax(240px,340px);gap:12px;max-width:820px;margin:0 auto;overflow-x:auto;overscroll-behavior-inline:contain;scroll-snap-type:inline mandatory;padding:2px 4px 12px;scrollbar-color:rgba(227,181,62,.65) rgba(255,255,255,.08)}
.review-slide{scroll-snap-align:start;background:var(--glass);border:1px solid var(--glass-line);border-radius:16px;padding:18px 16px;backdrop-filter:blur(8px);color:inherit;text-decoration:none;display:flex;flex-direction:column;gap:8px;min-height:100%;transition:transform .25s,border-color .25s}
.review-slide:hover{transform:translateY(-3px);border-color:rgba(127,198,232,.65)}
.review-tag{align-self:flex-start;font-size:.6rem;letter-spacing:.1em;text-transform:uppercase;color:var(--gold);border:1px solid rgba(227,181,62,.35);border-radius:999px;padding:3px 8px}
.review-slider .quote{margin:0;flex:1;font-size:.88rem;line-height:1.55}
.review-slider .who{margin-top:auto;font-size:.86rem}
.review-slider .who small{font-size:.72rem}
.review-slider .stars{font-size:1rem}
.review-slider .via-g{font-size:.6rem}
.review-slider-note{text-align:center;margin-top:.65rem;font-size:.9rem}
